...
final class TypeValidator
{
    ...
    public static function assertDateTime(mixed $value, string $format, string $field): \DateTime
    {
        ...
        if (false === $result) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" could not be parsed as DateTime with format "%s"', $field, $format)
            );
        }
    ...
    public static function assertInstanceOf(mixed $value, string $class, string $field): object
    {
        if (!$value instanceof $class) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected %s, got %s', $field, $class, get_debug_type($value))
            );
        }
    ...
    public static function assertListOfString(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of string, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            if (!\is_string($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of string, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOfNullableString(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of string|null, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            if (null !== $item && !\is_string($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of string|null, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOfInt(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of int, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            if (!\is_int($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of int, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOfNullableInt(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of int|null, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            if (null !== $item && !\is_int($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of int|null, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOfFloat(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of float, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            ...
            if (!\is_float($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of float, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOfNullableFloat(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of float|null, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            ...
            if (!\is_float($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of float|null, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOfBool(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of bool, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            ...
            if (!\is_bool($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of bool, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOfNullableBool(mixed $value, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of bool|null, got %s', $field, \get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            ...
            if (!\is_bool($item)) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of bool|null, got element %s', $field, \get_debug_type($item))
                );
            }
            $list[] = $item;
        }
    ...
    public static function assertListOf(mixed $value, string $class, string $field): array
    {
        if (!\is_array($value)) {
            throw new \UnexpectedValueException(
                \sprintf('Field "%s" expected list of %s, got %s', $field, $class, get_debug_type($value))
            );
        }
        ...
        foreach ($value as $item) {
            if (!$item instanceof $class) {
                throw new \UnexpectedValueException(
                    \sprintf('Field "%s" expected list of %s, got element %s', $field, $class, get_debug_type($item))
                );
            }
            $list[] = $item;
        }
