...
class HostnameValidator implements ValidatorInterface
{
    ...
    public function supports(mixed $object): bool
    {
        ...
        return $object instanceof JsonSchema && ((\is_array($object->getType()) ? \in_array('string', $object->getType(), true) : 'string' === $object->getType()) || null === $object->getType()) && 'hostname' === $object->getFormat();
    }
