...
class IPv6Validator implements ValidatorInterface
{
    ...
    {
        return $object instanceof JsonSchema && ((\is_array($object->getType()) ? \in_array('string', $object->getType(), true) : 'string' === $object->getType()) || null === $object->getType()) && 'ipv6' === $object->getFormat();
    }
