...
class MaxPropertiesValidator implements ValidatorInterface
{
    ...
    {
        return $object instanceof JsonSchema && ((\is_array($object->getType()) ? \in_array('object', $object->getType(), true) : 'object' === $object->getType()) || (null === $object->getType() && \is_array($object->getProperties()) && [] !== $object->getProperties())) && \is_int($object->getMaxProperties());
    }
