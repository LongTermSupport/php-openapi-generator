...
class OAuth2SecuritySchemeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \LongTermSupport\OpenApiGenerator\Component\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return $data instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme;
    }
    ...
    {
        $object = new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme();
        ...
        if (\array_key_exists('flows', $data) && null !== $data['flows']) {
            $object->setFlows($this->denormalizer->denormalize($data['flows'], \LongTermSupport\OpenApiGenerator\Component\OpenApi3\JsonSchema\Model\OAuthFlows::class, 'json', $context));
            unset($data['flows']);
        } elseif (\array_key_exists('flows', $data) && null === $data['flows']) {
    ...
    {
        if (!$object instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme) {
            throw new LogicException('Expected OAuth2SecurityScheme, got ' . get_debug_type($object));
        }
    ...
    {
        return [\LongTermSupport\OpenApiGenerator\Component\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme::class => false];
    }
}
