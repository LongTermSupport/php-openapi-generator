...
class Client extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AllBooleanQueryResolver\Runtime\Client\Client
{
    /**
     * @param array{
     *    "testBoolean"?: bool,
    ...
    {
        $result = $this->executeEndpoint(new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AllBooleanQueryResolver\Endpoint\GetFoo($queryParameters), $fetch);
    ...
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = []): self
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AllBooleanQueryResolver\Normalizer\JaneObjectNormalizer()];
