...
class Client extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AllBooleanQueryResolver\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AllBooleanQueryResolver\Endpoint\GetFoo($queryParameters), $fetch);
    }
    /**
