...
namespace LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\ApiPlatformDemo\Exception;

class ApiParchmentsIdDeleteNotFoundException extends NotFoundException
{
