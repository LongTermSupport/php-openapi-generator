 ...
 */
class BooksBookIdReviewsGetLdjsonResponse200HydraSearch extends \ArrayObject
{
    /**
    ...
    public function setHydraMapping(BooksBookIdReviewsGetLdjsonResponse200HydraSearchHydraMappingItem ...$hydraMapping): self
    {
