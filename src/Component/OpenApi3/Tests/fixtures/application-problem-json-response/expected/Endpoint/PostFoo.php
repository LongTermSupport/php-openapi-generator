...
class PostFoo extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\ApplicationProblemJsonResponse\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\ApplicationProblemJsonResponse\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): null
    {
        ...
        if ($contentType !== null && (400 === $status && str_contains(strtolower($contentType), 'application/problem+json'))) {
        ...
        if ($contentType !== null && (500 === $status && str_contains(strtolower($contentType), 'application/problem+json'))) {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\ApplicationProblemJsonResponse\Exception\UnexpectedStatusCodeException($status, $body, 'POST /foo');
    }
    /**
     * @return list<string>
     */
