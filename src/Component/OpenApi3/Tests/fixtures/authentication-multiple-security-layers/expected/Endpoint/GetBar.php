...
class GetBar extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AuthenticationMultipleSecurityLayers\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AuthenticationMultipleSecurityLayers\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): null
    {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\AuthenticationMultipleSecurityLayers\Exception\UnexpectedStatusCodeException($status, $body, 'GET /bar');
    }
    /**
     * @return list<string>
     */
