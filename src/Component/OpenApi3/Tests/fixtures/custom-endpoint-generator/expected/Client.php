...
namespace LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\CustomEndpointGenerator;

class Client extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\CustomEndpointGenerator\Runtime\Client\Client
{
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\CustomEndpointGenerator\Exception\UnexpectedStatusCodeException
     */
    public function testReferenceResponse(string $fetch = self::FETCH_OBJECT): null|\Psr\Http\Message\ResponseInterface
    {
        $result = $this->executeEndpoint(new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\CustomEndpointGenerator\Endpoint\TestReferenceResponse(), $fetch);
    ...
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = []): self
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\CustomEndpointGenerator\Normalizer\JaneObjectNormalizer()];
