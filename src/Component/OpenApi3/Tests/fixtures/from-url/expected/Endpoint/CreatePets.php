...
class CreatePets extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\FromUrl\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\FromUrl\Runtime\Client\Endpoint
{
    /**
     * @param \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\FromUrl\Model\Pet $requestBody
     */
    public function __construct(\LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\FromUrl\Model\Pet $requestBody)
    {
    ...
    {
        if ($this->body instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\FromUrl\Model\Pet) {
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): null|\LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\FromUrl\Model\Error
    {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\FromUrl\Exception\UnexpectedStatusCodeException($status, $body, 'POST /pets');
    }
    /**
     * @return list<string>
     */
