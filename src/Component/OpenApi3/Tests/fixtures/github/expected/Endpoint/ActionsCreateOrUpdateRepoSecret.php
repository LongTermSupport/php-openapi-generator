...
class ActionsCreateOrUpdateRepoSecret extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $owner, string $repo, string $secretName, ?\LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Model\ReposOwnerRepoActionsSecretsSecretNamePutBody $requestBody = null)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    {
        if ($this->body instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Model\ReposOwnerRepoActionsSecretsSecretNamePutBody) {
