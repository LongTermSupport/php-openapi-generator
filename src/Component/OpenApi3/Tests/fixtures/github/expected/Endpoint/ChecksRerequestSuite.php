...
class ChecksRerequestSuite extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{owner}', '{repo}', '{check_suite_id}'], [(string) $this->owner, (string) $this->repo, (string) $this->check_suite_id], '/repos/{owner}/{repo}/check-suites/{check_suite_id}/rerequest');
    }
    /**
