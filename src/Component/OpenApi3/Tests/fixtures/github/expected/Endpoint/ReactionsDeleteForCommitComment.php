...
class ReactionsDeleteForCommitComment extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Github\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{owner}', '{repo}', '{comment_id}', '{reaction_id}'], [$this->owner, $this->repo, (string) $this->comment_id, (string) $this->reaction_id], '/repos/{owner}/{repo}/comments/{comment_id}/reactions/{reaction_id}');
    }
    /**
