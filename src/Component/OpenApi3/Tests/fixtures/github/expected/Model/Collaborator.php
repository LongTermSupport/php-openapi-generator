 ...
 */
class Collaborator extends \ArrayObject
{
    /**
    ...
    protected CollaboratorPermissions $permissions;
    ...
    public function getPermissions(): CollaboratorPermissions
    {
        return $this->permissions;
    }
    public function setPermissions(CollaboratorPermissions $permissions): self
    {
