 ...
 */
class ContentTreeEntriesItem extends \ArrayObject
{
    /**
    ...
    public function getLinks(): ContentTreeEntriesItemLinks
    {
        return $this->links;
    }
    public function setLinks(ContentTreeEntriesItemLinks $links): self
    {
