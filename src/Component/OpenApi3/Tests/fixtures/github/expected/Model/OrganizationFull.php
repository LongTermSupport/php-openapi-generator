...
class OrganizationFull extends \ArrayObject
{
    ...
    protected ?int $privateGists = null;
    protected ?int $diskUsage = null;
    protected ?int $collaborators = null;
    protected ?string $billingEmail = null;
    protected OrganizationFullPlan $plan;
    protected ?string $defaultRepositoryPermission = null;
    protected ?bool $membersCanCreateRepositories = null;
    protected ?bool $twoFactorRequirementEnabled = null;
