...
class ReposOwnerRepoBranchesBranchProtectionPutBody extends \ArrayObject
{
     ...
     *
     */
    protected ?ReposOwnerRepoBranchesBranchProtectionPutBodyRequiredStatusChecks $requiredStatusChecks;
    /**
     * Enforce all configured restrictions for administrators. Set to `true` to enforce required status checks for repository administrators. Set to `null` to disable.
     *
     */
    protected ?bool $enforceAdmins;
    /**
     * Require at least one approving review on a pull request, before merging. Set to `null` to disable.
     *
     */
    protected ?ReposOwnerRepoBranchesBranchProtectionPutBodyRequiredPullRequestReviews $requiredPullRequestReviews;
    /**
     * Restrict who can push to the protected branch. User, app, and team `restrictions` are only available for organization-owned repositories. Set to `null` to disable.
     *
     */
    protected ?ReposOwnerRepoBranchesBranchProtectionPutBodyRestrictions $restrictions;
    /**
     ...
     *
     */
    protected ?bool $allowForcePushes;
    /**
