 ...
 */
class RepositoryTemplateRepository extends \ArrayObject
{
    /**
    ...
    protected RepositoryTemplateRepositoryOwner $owner;
    ...
    protected RepositoryTemplateRepositoryPermissions $permissions;
