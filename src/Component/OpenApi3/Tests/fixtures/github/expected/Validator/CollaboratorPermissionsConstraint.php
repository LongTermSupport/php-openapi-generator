...
class CollaboratorPermissionsConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['pull' => new \Symfony\Component\Validator\Constraints\Required([]), 'push' => new \Symfony\Component\Validator\Constraints\Required([]), 'admin' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}