...
class FileCommitConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['content' => new \Symfony\Component\Validator\Constraints\Optional([]), 'commit' => new \Symfony\Component\Validator\Constraints\Optional([])], allowExtraFields: true)];
    }
}