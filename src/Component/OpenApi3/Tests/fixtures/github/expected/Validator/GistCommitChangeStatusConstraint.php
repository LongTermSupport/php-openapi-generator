...
class GistCommitChangeStatusConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['total' => new \Symfony\Component\Validator\Constraints\Optional([]), 'additions' => new \Symfony\Component\Validator\Constraints\Optional([]), 'deletions' => new \Symfony\Component\Validator\Constraints\Optional([])], allowExtraFields: true)];
    }
}