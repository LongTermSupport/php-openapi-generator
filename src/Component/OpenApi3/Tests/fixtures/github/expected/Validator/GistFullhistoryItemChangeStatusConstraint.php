...
class GistFullhistoryItemChangeStatusConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['deletions' => new \Symfony\Component\Validator\Constraints\Optional([]), 'additions' => new \Symfony\Component\Validator\Constraints\Optional([]), 'total' => new \Symfony\Component\Validator\Constraints\Optional([])], allowExtraFields: true)];
    }
}