...
class GpgKeyEmailsItemConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['email' => new \Symfony\Component\Validator\Constraints\Optional([]), 'verified' => new \Symfony\Component\Validator\Constraints\Optional([])], allowExtraFields: true)];
    }
}