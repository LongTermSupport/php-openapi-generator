...
class InteractionLimitConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['limit' => new \Symfony\Component\Validator\Constraints\Required([]), 'origin' => new \Symfony\Component\Validator\Constraints\Required([]), 'expires_at' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}