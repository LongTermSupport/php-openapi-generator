...
class PagesSourceHashConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['branch' => new \Symfony\Component\Validator\Constraints\Required([]), 'path' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}