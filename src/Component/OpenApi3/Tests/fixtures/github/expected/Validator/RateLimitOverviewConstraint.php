...
class RateLimitOverviewConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['resources' => new \Symfony\Component\Validator\Constraints\Required([]), 'rate' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}