...
class ReposOwnerRepoActionsWorkflowsWorkflowIdDispatchesPostBodyConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['ref' => new \Symfony\Component\Validator\Constraints\Required([]), 'inputs' => new \Symfony\Component\Validator\Constraints\Optional([])], allowExtraFields: true)];
    }
}