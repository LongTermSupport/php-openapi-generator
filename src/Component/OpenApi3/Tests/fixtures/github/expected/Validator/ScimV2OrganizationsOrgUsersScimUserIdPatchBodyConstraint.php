...
class ScimV2OrganizationsOrgUsersScimUserIdPatchBodyConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['schemas' => new \Symfony\Component\Validator\Constraints\Optional([]), 'Operations' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}