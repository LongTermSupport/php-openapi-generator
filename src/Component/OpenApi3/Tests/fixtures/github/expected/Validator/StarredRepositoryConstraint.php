...
class StarredRepositoryConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['starred_at' => new \Symfony\Component\Validator\Constraints\Required([]), 'repo' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}