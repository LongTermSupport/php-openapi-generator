...
class TrafficConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['timestamp' => new \Symfony\Component\Validator\Constraints\Required([]), 'uniques' => new \Symfony\Component\Validator\Constraints\Required([]), 'count' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}