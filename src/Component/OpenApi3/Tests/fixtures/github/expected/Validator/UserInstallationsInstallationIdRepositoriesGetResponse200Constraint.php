...
class UserInstallationsInstallationIdRepositoriesGetResponse200Constraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['total_count' => new \Symfony\Component\Validator\Constraints\Optional([]), 'repository_selection' => new \Symfony\Component\Validator\Constraints\Optional([]), 'repositories' => new \Symfony\Component\Validator\Constraints\Optional([])], allowExtraFields: true)];
    }
}