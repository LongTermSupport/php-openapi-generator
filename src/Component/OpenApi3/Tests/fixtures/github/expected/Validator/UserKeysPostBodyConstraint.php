...
class UserKeysPostBodyConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['title' => new \Symfony\Component\Validator\Constraints\Optional([]), 'key' => new \Symfony\Component\Validator\Constraints\Required([])], allowExtraFields: true)];
    }
}