...
class WorkflowRunUsageConstraint extends \Symfony\Component\Validator\Constraints\Compound
{
    ...
    {
        return [new \Symfony\Component\Validator\Constraints\Collection(fields: ['billable' => new \Symfony\Component\Validator\Constraints\Optional([]), 'run_duration_ms' => new \Symfony\Component\Validator\Constraints\Optional([])], allowExtraFields: true)];
    }
}