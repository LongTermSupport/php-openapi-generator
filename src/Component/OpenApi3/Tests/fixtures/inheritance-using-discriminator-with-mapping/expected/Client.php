...
namespace LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\InheritanceUsingDiscriminatorWithMapping;

class Client extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\InheritanceUsingDiscriminatorWithMapping\Runtime\Client\Client
{
    /**
    ...
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = []): self
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\InheritanceUsingDiscriminatorWithMapping\Normalizer\JaneObjectNormalizer()];
