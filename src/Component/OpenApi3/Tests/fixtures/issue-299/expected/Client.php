...
namespace LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue299;

class Client extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue299\Runtime\Client\Client
{
    /**
     * Foo bar
     *
    ...
    {
        return $this->executeEndpoint(new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue299\Endpoint\GetUsers($queryParameters), $fetch);
    }
    /**
    ...
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = []): self
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue299\Normalizer\JaneObjectNormalizer()];
