 ...
 */
class ActivityMappingInvalidException extends \ArrayObject
{
    /**
    ...
    protected ?string $activityMapping = null;
    ...
    public function getActivityMapping(): ?string
    {
        return $this->activityMapping;
    }
    public function setActivityMapping(?string $activityMapping): self
    {
        $this->initialized['activityMapping'] = true;
