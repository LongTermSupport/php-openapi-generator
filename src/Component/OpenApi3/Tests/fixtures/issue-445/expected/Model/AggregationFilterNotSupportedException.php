 ...
 */
class AggregationFilterNotSupportedException extends \ArrayObject
{
    /**
    ...
    public function getNotSupportedFilterType(): ?string
    {
        return $this->notSupportedFilterType;
    }
    public function setNotSupportedFilterType(?string $notSupportedFilterType): self
    {
        $this->initialized['notSupportedFilterType'] = true;
        $this->notSupportedFilterType = $notSupportedFilterType;
        return $this;
    }
    /**
    ...
    {
        $this->initialized['supportedFilterTypes'] = true;
