 ...
 */
class BusinessProcessEngineRequestException extends \ArrayObject
{
    /**
    ...
    protected ?string $engineError = null;
    ...
    public function setEngineError(?string $engineError): self
    {
        $this->initialized['engineError'] = true;
