 ...
 */
class ContentLayerInvalidException extends \ArrayObject
{
    /**
    ...
    protected ?string $layerIds = null;
    ...
    public function getLayerIds(): ?string
    {
        return $this->layerIds;
    }
    public function setLayerIds(?string $layerIds): self
    {
        $this->initialized['layerIds'] = true;
