 ...
 */
class ContentMetadataUpdateManyException extends \ArrayObject
{
    /**
    ...
    protected int $failedItemsCount;
    ...
    public function setFailedItemsCount(int $failedItemsCount): self
    {
        $this->initialized['failedItemsCount'] = true;
    ...
    {
        $this->initialized['totalItemsCount'] = true;
