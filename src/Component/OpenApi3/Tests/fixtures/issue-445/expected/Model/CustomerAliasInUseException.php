...
class CustomerAliasInUseException extends \ArrayObject
{
    ...
    protected ?string $existingCustomerId = null;
    ...
    public function getExistingCustomerId(): ?string
    {
        return $this->existingCustomerId;
    }
    public function setExistingCustomerId(?string $existingCustomerId): self
    {
        $this->initialized['existingCustomerId'] = true;
