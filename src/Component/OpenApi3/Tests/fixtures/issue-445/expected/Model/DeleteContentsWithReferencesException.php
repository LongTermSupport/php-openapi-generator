 ...
 */
class DeleteContentsWithReferencesException extends \ArrayObject
{
    /**
    ...
    public function setNumberOfReferences(int $numberOfReferences): self
    {
        $this->initialized['numberOfReferences'] = true;
    ...
    {
        $this->initialized['numberOfShares'] = true;
