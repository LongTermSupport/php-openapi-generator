...
class DuplicateMetadataDisplayPatternException extends \ArrayObject
{
    ...
    protected ?string $displayPatternId = null;
    ...
    public function getDisplayPatternId(): ?string
    {
        return $this->displayPatternId;
    }
    public function setDisplayPatternId(?string $displayPatternId): self
    {
        $this->initialized['displayPatternId'] = true;
