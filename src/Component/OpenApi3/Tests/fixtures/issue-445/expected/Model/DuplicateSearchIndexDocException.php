 ...
 */
class DuplicateSearchIndexDocException extends \ArrayObject
{
    /**
    ...
    protected ?string $searchIndexDocId = null;
    ...
    public function getSearchIndexDocId(): ?string
    {
        return $this->searchIndexDocId;
    }
    public function setSearchIndexDocId(?string $searchIndexDocId): self
    {
        $this->initialized['searchIndexDocId'] = true;
