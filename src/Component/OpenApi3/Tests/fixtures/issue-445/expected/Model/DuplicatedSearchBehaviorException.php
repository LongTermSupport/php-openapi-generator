...
class DuplicatedSearchBehaviorException extends \ArrayObject
{
    ...
    protected ?string $duplicatedSearchBehaviors = null;
    ...
    public function getDuplicatedSearchBehaviors(): ?string
    {
        return $this->duplicatedSearchBehaviors;
    }
    public function setDuplicatedSearchBehaviors(?string $duplicatedSearchBehaviors): self
    {
        $this->initialized['duplicatedSearchBehaviors'] = true;
        $this->duplicatedSearchBehaviors = $duplicatedSearchBehaviors;
        return $this;
    }
}