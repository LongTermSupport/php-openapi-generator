...
class EnvironmentProcessAlreadyRunningException extends \ArrayObject
{
    ...
    protected string $environmentProcessType;
    ...
    public function getEnvironmentProcessType(): string
    {
        return $this->environmentProcessType;
    }
    public function setEnvironmentProcessType(string $environmentProcessType): self
    {
        $this->initialized['environmentProcessType'] = true;
        $this->environmentProcessType = $environmentProcessType;
        return $this;
    }
}