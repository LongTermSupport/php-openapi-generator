...
class EnvironmentProcessWaitTimeoutException extends \ArrayObject
{
    ...
    protected ?string $environmentProcessId = null;
    protected ?string $waitedLifecycles = null;
    ...
    public function getWaitedLifecycles(): ?string
    {
        return $this->waitedLifecycles;
    }
    public function setWaitedLifecycles(?string $waitedLifecycles): self
    {
        $this->initialized['waitedLifecycles'] = true;
        $this->waitedLifecycles = $waitedLifecycles;
        return $this;
    }
}