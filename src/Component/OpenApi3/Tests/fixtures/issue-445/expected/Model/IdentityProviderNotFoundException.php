 ...
 */
class IdentityProviderNotFoundException extends \ArrayObject
{
    /**
    ...
    protected ?string $missingIdentityProviderId = null;
    ...
    public function getMissingIdentityProviderId(): ?string
    {
        return $this->missingIdentityProviderId;
    }
    public function setMissingIdentityProviderId(?string $missingIdentityProviderId): self
    {
        $this->initialized['missingIdentityProviderId'] = true;
        $this->missingIdentityProviderId = $missingIdentityProviderId;
        return $this;
    }
