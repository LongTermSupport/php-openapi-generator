 ...
 */
class IllegalAuthorizationStateTransitionException extends \ArrayObject
{
    /**
    ...
    public function setRequestedUserId(?string $requestedUserId): self
    {
        $this->initialized['requestedUserId'] = true;
