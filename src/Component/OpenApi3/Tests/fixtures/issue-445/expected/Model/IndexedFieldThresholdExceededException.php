...
class IndexedFieldThresholdExceededException extends \ArrayObject
{
    ...
    protected float $indexedFieldCount;
    protected int $indexedFieldThreshold;
    ...
    public function getIndexedFieldCount(): float
    {
        return $this->indexedFieldCount;
    }
    public function setIndexedFieldCount(float $indexedFieldCount): self
    {
        $this->initialized['indexedFieldCount'] = true;
        $this->indexedFieldCount = $indexedFieldCount;
        return $this;
    }
    public function getIndexedFieldThreshold(): int
    {
        return $this->indexedFieldThreshold;
    }
    public function setIndexedFieldThreshold(int $indexedFieldThreshold): self
    {
        $this->initialized['indexedFieldThreshold'] = true;
