 ...
 */
class InvalidChangeCommandFieldNotFoundException extends \ArrayObject
{
    /**
    ...
    protected ?string $commandTypeName = null;
    ...
    public function getCommandTypeName(): ?string
    {
        return $this->commandTypeName;
    }
    public function setCommandTypeName(?string $commandTypeName): self
    {
        $this->initialized['commandTypeName'] = true;
