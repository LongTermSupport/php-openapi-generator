 ...
 */
class MissingCustomerDefaultLanguageException extends \ArrayObject
{
    /**
    ...
    protected ?string $customerDefaultLanguage = null;
    ...
    public function setCustomerDefaultLanguage(?string $customerDefaultLanguage): self
    {
        $this->initialized['customerDefaultLanguage'] = true;
        $this->customerDefaultLanguage = $customerDefaultLanguage;
        return $this;
    }
}