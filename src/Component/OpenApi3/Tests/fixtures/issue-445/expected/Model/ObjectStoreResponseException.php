 ...
 */
class ObjectStoreResponseException extends \ArrayObject
{
    /**
    ...
    protected ?string $rowErrorMessages = null;
    ...
    public function getRowErrorMessages(): ?string
    {
        return $this->rowErrorMessages;
    }
    public function setRowErrorMessages(?string $rowErrorMessages): self
    {
        $this->initialized['rowErrorMessages'] = true;
