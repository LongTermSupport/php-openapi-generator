 ...
 */
class OperationInProgressException extends \ArrayObject
{
    /**
    ...
    protected string $leaseResourceType;
    ...
    public function getLeaseResourceType(): string
    {
        return $this->leaseResourceType;
    }
    public function setLeaseResourceType(string $leaseResourceType): self
    {
        $this->initialized['leaseResourceType'] = true;
