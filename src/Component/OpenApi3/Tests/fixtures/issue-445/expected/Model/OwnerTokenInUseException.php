 ...
 */
class OwnerTokenInUseException extends \ArrayObject
{
    /**
    ...
    protected ?string $ownerTokenUserId = null;
    ...
    public function getOwnerTokenUserId(): ?string
    {
        return $this->ownerTokenUserId;
    }
    public function setOwnerTokenUserId(?string $ownerTokenUserId): self
    {
        $this->initialized['ownerTokenUserId'] = true;
