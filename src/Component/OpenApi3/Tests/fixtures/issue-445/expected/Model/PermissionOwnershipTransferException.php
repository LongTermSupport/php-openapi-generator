 ...
 */
class PermissionOwnershipTransferException extends \ArrayObject
{
    /**
    ...
    protected string $missingUserRight;
    ...
    public function getMissingUserRight(): string
    {
        return $this->missingUserRight;
    }
    public function setMissingUserRight(string $missingUserRight): self
    {
        $this->initialized['missingUserRight'] = true;
