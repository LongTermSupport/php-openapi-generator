 ...
 */
class RelationTypeTargetDocTypeMismatchException extends \ArrayObject
{
    /**
    ...
    public function getExpectedTargetDocType(): ?string
    {
        return $this->expectedTargetDocType;
    }
    public function setExpectedTargetDocType(?string $expectedTargetDocType): self
    {
        $this->initialized['expectedTargetDocType'] = true;
