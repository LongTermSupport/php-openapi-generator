 ...
 */
class RetryException extends \ArrayObject
{
    /**
    ...
    public function getInnerExceptionDetail(): ?string
    {
        return $this->innerExceptionDetail;
    }
    public function setInnerExceptionDetail(?string $innerExceptionDetail): self
    {
        $this->initialized['innerExceptionDetail'] = true;
