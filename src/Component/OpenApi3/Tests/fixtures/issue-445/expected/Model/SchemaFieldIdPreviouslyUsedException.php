...
class SchemaFieldIdPreviouslyUsedException extends \ArrayObject
{
    ...
    protected ?string $usedInSchemaId = null;
    ...
    public function getUsedInSchemaId(): ?string
    {
        return $this->usedInSchemaId;
    }
    public function setUsedInSchemaId(?string $usedInSchemaId): self
    {
