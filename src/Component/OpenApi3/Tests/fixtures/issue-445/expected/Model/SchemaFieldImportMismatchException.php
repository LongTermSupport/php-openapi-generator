 ...
 */
class SchemaFieldImportMismatchException extends \ArrayObject
{
    /**
    ...
    protected ?string $importingFieldIds = null;
    protected ?string $existingFieldIds = null;
    ...
    public function getImportingFieldIds(): ?string
    {
        return $this->importingFieldIds;
    }
    public function setImportingFieldIds(?string $importingFieldIds): self
    {
        $this->initialized['importingFieldIds'] = true;
        $this->importingFieldIds = $importingFieldIds;
        return $this;
    }
    public function getExistingFieldIds(): ?string
    {
        return $this->existingFieldIds;
    }
    public function setExistingFieldIds(?string $existingFieldIds): self
    {
        $this->initialized['existingFieldIds'] = true;
