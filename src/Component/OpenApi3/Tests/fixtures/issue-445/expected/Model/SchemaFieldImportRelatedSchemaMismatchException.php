 ...
 */
class SchemaFieldImportRelatedSchemaMismatchException extends \ArrayObject
{
    /**
    ...
    protected ?string $importingRelatedSchemaId = null;
    protected ?string $existingRelatedSchemaId = null;
    ...
    public function getImportingRelatedSchemaId(): ?string
    {
        return $this->importingRelatedSchemaId;
    }
    public function setImportingRelatedSchemaId(?string $importingRelatedSchemaId): self
    {
        $this->initialized['importingRelatedSchemaId'] = true;
        $this->importingRelatedSchemaId = $importingRelatedSchemaId;
        return $this;
    }
    public function getExistingRelatedSchemaId(): ?string
    {
        return $this->existingRelatedSchemaId;
    }
    public function setExistingRelatedSchemaId(?string $existingRelatedSchemaId): self
    {
        $this->initialized['existingRelatedSchemaId'] = true;
