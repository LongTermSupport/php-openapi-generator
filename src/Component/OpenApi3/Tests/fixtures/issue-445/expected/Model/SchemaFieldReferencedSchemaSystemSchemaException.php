 ...
 */
class SchemaFieldReferencedSchemaSystemSchemaException extends \ArrayObject
{
    /**
    ...
    protected ?string $referencedSchemaId = null;
    ...
    public function getReferencedSchemaId(): ?string
    {
        return $this->referencedSchemaId;
    }
    public function setReferencedSchemaId(?string $referencedSchemaId): self
    {
        $this->initialized['referencedSchemaId'] = true;
