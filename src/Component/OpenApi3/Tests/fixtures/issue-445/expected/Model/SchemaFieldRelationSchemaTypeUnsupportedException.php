 ...
 */
class SchemaFieldRelationSchemaTypeUnsupportedException extends \ArrayObject
{
    /**
    ...
    protected ?string $relationSchemaId = null;
    ...
    public function getRelationSchemaId(): ?string
    {
        return $this->relationSchemaId;
    }
    public function setRelationSchemaId(?string $relationSchemaId): self
    {
        $this->initialized['relationSchemaId'] = true;
