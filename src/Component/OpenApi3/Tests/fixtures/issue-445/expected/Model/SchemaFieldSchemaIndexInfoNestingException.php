 ...
 */
class SchemaFieldSchemaIndexInfoNestingException extends \ArrayObject
{
    /**
    ...
    public function getRelatedFieldId(): ?string
    {
        return $this->relatedFieldId;
    }
    public function setRelatedFieldId(?string $relatedFieldId): self
    {
        $this->initialized['relatedFieldId'] = true;
        $this->relatedFieldId = $relatedFieldId;
        return $this;
    }
    public function getRelatedOuterFieldId(): ?string
    {
        return $this->relatedOuterFieldId;
    }
    public function setRelatedOuterFieldId(?string $relatedOuterFieldId): self
    {
