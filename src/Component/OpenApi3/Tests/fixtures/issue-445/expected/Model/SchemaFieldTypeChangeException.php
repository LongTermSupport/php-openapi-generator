 ...
 */
class SchemaFieldTypeChangeException extends \ArrayObject
{
    /**
    ...
    protected ?string $oldTypeName = null;
    ...
    public function setOldTypeName(?string $oldTypeName): self
    {
        $this->initialized['oldTypeName'] = true;
    ...
    public function setNewTypeName(?string $newTypeName): self
    {
        $this->initialized['newTypeName'] = true;
