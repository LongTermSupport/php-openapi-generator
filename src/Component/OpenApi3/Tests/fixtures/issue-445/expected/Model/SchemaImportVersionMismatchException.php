 ...
 */
class SchemaImportVersionMismatchException extends \ArrayObject
{
    /**
    ...
    protected ?string $providedVersion = null;
    ...
    public function getProvidedVersion(): ?string
    {
        return $this->providedVersion;
    }
    public function setProvidedVersion(?string $providedVersion): self
    {
        $this->initialized['providedVersion'] = true;
