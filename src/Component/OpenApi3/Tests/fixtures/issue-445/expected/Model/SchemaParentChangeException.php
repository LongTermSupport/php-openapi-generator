...
class SchemaParentChangeException extends \ArrayObject
{
    ...
    protected ?string $oldSchemaParentId = null;
    protected ?string $newSchemaParentId = null;
    ...
    public function getOldSchemaParentId(): ?string
    {
        return $this->oldSchemaParentId;
    }
    public function setOldSchemaParentId(?string $oldSchemaParentId): self
    {
        $this->initialized['oldSchemaParentId'] = true;
        $this->oldSchemaParentId = $oldSchemaParentId;
        return $this;
    }
    public function getNewSchemaParentId(): ?string
    {
        return $this->newSchemaParentId;
    }
    public function setNewSchemaParentId(?string $newSchemaParentId): self
    {
        $this->initialized['newSchemaParentId'] = true;
