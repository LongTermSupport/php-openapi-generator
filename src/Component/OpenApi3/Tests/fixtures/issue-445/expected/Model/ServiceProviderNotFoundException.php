 ...
 */
class ServiceProviderNotFoundException extends \ArrayObject
{
    /**
    ...
    protected ?string $missingServiceProviderId = null;
    ...
    public function getMissingServiceProviderId(): ?string
    {
        return $this->missingServiceProviderId;
    }
    public function setMissingServiceProviderId(?string $missingServiceProviderId): self
    {
        $this->initialized['missingServiceProviderId'] = true;
