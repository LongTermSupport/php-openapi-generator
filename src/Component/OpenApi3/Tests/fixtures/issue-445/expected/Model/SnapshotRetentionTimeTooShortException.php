 ...
 */
class SnapshotRetentionTimeTooShortException extends \ArrayObject
{
    /**
    ...
    protected string $snapshotRetentionTime;
    protected string $minimumRetentionTime;
    ...
    public function getSnapshotRetentionTime(): string
    {
        return $this->snapshotRetentionTime;
    }
    public function setSnapshotRetentionTime(string $snapshotRetentionTime): self
    {
        $this->initialized['snapshotRetentionTime'] = true;
        $this->snapshotRetentionTime = $snapshotRetentionTime;
        return $this;
    }
    public function getMinimumRetentionTime(): string
    {
        return $this->minimumRetentionTime;
    }
    public function setMinimumRetentionTime(string $minimumRetentionTime): self
    {
        $this->initialized['minimumRetentionTime'] = true;
