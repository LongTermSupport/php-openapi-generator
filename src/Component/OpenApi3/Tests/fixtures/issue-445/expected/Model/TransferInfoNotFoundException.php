 ...
 */
class TransferInfoNotFoundException extends \ArrayObject
{
    /**
    ...
    protected ?string $transferInfoId = null;
    ...
    public function getTransferInfoId(): ?string
    {
        return $this->transferInfoId;
    }
    public function setTransferInfoId(?string $transferInfoId): self
    {
        $this->initialized['transferInfoId'] = true;
