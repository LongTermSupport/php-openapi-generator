 ...
 */
class UserAttributeNotSynchronizableException extends \ArrayObject
{
    /**
    ...
    protected ?string $attributePath = null;
    ...
    public function setAttributePath(?string $attributePath): self
    {
        $this->initialized['attributePath'] = true;
