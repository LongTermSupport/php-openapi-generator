...
class UserNotFoundException extends \ArrayObject
{
    ...
    protected ?string $missingUserId = null;
    ...
    public function getMissingUserId(): ?string
    {
        return $this->missingUserId;
    }
    public function setMissingUserId(?string $missingUserId): self
    {
        $this->initialized['missingUserId'] = true;
