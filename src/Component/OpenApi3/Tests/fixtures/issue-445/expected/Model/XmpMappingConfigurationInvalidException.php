 ...
 */
class XmpMappingConfigurationInvalidException extends \ArrayObject
{
    /**
    ...
    protected ?string $expectedConfiguration = null;
    ...
    public function setExpectedConfiguration(?string $expectedConfiguration): self
    {
        $this->initialized['expectedConfiguration'] = true;
