...
class TestGetWithDefaultValuesInPathParameters extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue649\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue649\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): never
    {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue649\Exception\UnexpectedStatusCodeException($status, $body, 'GET /test-path-parameters/{testPath}');
    }
    /**
     * @return list<string>
     */
