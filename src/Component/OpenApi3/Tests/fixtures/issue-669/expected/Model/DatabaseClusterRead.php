 ...
 */
class DatabaseClusterRead extends \ArrayObject
{
    /**
    ...
    protected DatabaseClusterReadPrivateConnection $privateConnection;
    protected DatabaseClusterReadStandbyConnection $standbyConnection;
    protected DatabaseClusterReadStandbyPrivateConnection $standbyPrivateConnection;
    /**
