...
class AppWorkerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    /**
     * @return \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppWorkerSpec|Reference
     */
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppWorkerSpec|Reference
    {
        ...
        if (\array_key_exists('termination', $data)) {
            $value_10 = $this->denormalizer->denormalize($data['termination'], \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppWorkerSpecTermination::class, 'json', $context);
            if (!$value_10 instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppWorkerSpecTermination) {
                throw new \LogicException('Expected LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppWorkerSpecTermination, got ' . get_debug_type($value_10));
            }
            $object->setTermination($value_10);
            unset($data['termination']);
        }
        if (\array_key_exists('liveness_health_check', $data)) {
            $value_11 = $this->denormalizer->denormalize($data['liveness_health_check'], \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppHealthCheckSpec::class, 'json', $context);
            if (!$value_11 instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppHealthCheckSpec) {
                throw new \LogicException('Expected LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppHealthCheckSpec, got ' . get_debug_type($value_11));
            }
            $object->setLivenessHealthCheck($value_11);
