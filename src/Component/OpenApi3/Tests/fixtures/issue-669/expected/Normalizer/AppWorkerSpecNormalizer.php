...
class AppWorkerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('termination', $data)) {
            $value_10 = TypeValidator::assertInstanceOf($this->denormalizer->denormalize($data['termination'], \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppWorkerSpecTermination::class, 'json', $context), \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppWorkerSpecTermination::class, 'AppWorkerSpecTermination');
            $object->setTermination($value_10);
            unset($data['termination']);
        }
        if (\array_key_exists('liveness_health_check', $data)) {
            $value_11 = TypeValidator::assertInstanceOf($this->denormalizer->denormalize($data['liveness_health_check'], \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppHealthCheckSpec::class, 'json', $context), \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\AppHealthCheckSpec::class, 'AppHealthCheckSpec');
