...
class DropletBackupPolicyRecordNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord::class;
    }
    /**
     * @return \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord|Reference
     */
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord|Reference
    {
        $object = new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord();
        ...
        if (\array_key_exists('backup_enabled', $data)) {
            $object->setBackupEnabled(TypeValidator::assertBool($data['backup_enabled'], 'backup_enabled'));
    ...
    {
        if (!$data instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord) {
            throw new \LogicException('Expected LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord, got ' . get_debug_type($data));
        }
        $dataArray = [];
        if ($data->isInitialized('dropletId')) {
            $dataArray['droplet_id'] = $data->getDropletId();
        }
        if ($data->isInitialized('backupEnabled')) {
        ...
        if ($data->isInitialized('nextBackupWindow')) {
    ...
    {
        return [\LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue669\Model\DropletBackupPolicyRecord::class => false];
    }
}