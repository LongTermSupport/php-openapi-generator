...
class PostFile extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue737\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue737\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue737\Model\FilePostBody $requestBody = null)
    {
        $this->body = $requestBody;
    }
    use \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue737\Runtime\Client\EndpointTrait;
    ...
    {
        if ($this->body instanceof \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue737\Model\FilePostBody) {
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): mixed
    {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue737\Exception\UnexpectedStatusCodeException($status, $body, 'POST /File');
    }
    /**
     * @return list<string>
     */
