...
namespace LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue810;

class Client extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue810\Runtime\Client\Client
{
    /**
    ...
    {
        return $this->executeEndpoint(new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue810\Endpoint\MimeTypeGeneratedValidDocBlock($requestBody, $accept), $fetch);
    }
    /**
    ...
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = []): self
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue810\Normalizer\JaneObjectNormalizer()];
