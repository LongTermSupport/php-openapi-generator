...
class TestSimple extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue828\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue828\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): null
    {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Issue828\Exception\UnexpectedStatusCodeException($status, $body, 'POST /test-simple');
    }
    /**
     * @return list<string>
     */
