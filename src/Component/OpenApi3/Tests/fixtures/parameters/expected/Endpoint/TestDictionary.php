...
class TestDictionary extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Parameters\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Parameters\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): null
    {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Parameters\Exception\UnexpectedStatusCodeException($status, $body, 'POST /test-dictionary');
    }
    /**
     * @return list<string>
     */
