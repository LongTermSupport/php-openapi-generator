...
namespace LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\SimplePathArrayParameter;

class Client extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\SimplePathArrayParameter\Runtime\Client\Client
{
    /**
     * @param string $string
    ...
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = []): self
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\SimplePathArrayParameter\Normalizer\JaneObjectNormalizer()];
