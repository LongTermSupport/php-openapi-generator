...
class AddOrDeleteRules extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Twitter\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Twitter\Runtime\Client\Endpoint
{
    /**
     * @var list<string>
     */
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): mixed
    {
        ...
        throw new \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\Twitter\Exception\UnexpectedStatusCodeException($status, $body, 'POST /labs/1/tweets/stream/filter/rules');
    }
    /**
     * @return list<string>
     */
