...
class FindTweetsById extends \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Runtime\Client\BaseEndpoint implements \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Runtime\Client\Endpoint
{
    /**
     * @var list<string>
     */
     ...
     * {@inheritdoc}
     *
     * @throws \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Exception\UnexpectedStatusCodeException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null): mixed
    {
        ...
        if ($contentType !== null && (200 === $status && str_contains(strtolower($contentType), 'application/json'))) {
            return \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Runtime\Normalizer\TypeValidator::assertInstanceOf($serializer->deserialize($body, 'LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\TweetLookupResponse', 'json'), \LongTermSupport\OpenApiGenerator\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\TweetLookupResponse::class, 'response body');
        }
        if ($contentType !== null) {
